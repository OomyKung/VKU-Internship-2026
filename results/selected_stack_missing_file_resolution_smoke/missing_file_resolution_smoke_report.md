...
Selection stage
------------------------------------------------------------------------
report=missing_file_resolution_smoke
...
------------------------------------------------------------------------
final_selected_stack=graphsage_fair_ris_hybrid
total_spread=42.666666666666664
extra_spread=2.6666666666666643
MF=0.05845181674565561
DCV=0.028311390426319336
F-score=0.015070213159668137
runtime_seconds=5.3723208000083105
...
1. graphsage_fair_ris_hybrid [ok]
   spread=42.6667 | extra=2.6667 | MF=0.0585 | DCV=0.0283 | F-score=0.0151 | runtime=5.372s
   ...
   notes=ML guidance mode=two_tier; full_pool=500; tier_policy=tuned; backend=gnn_ris; weights=(graphsage=1.000, ris=1.000, fair_ris=0.500, fairness=0.200, diversity=0.000); target=label_score; target_variance=0.007816; gnn_model_type=graphsage; node2vec_mode=off; feature_shape=(500, 52); edge_index_shape=(2, 1938); cache=miss; label_variance=0.007816; ris_num_rr_sets=128; ris_mode=weak_group_weighted; fair_ris_enabled=True; ris_reuse_rr_sets=True; history=graph_spa_500_0_budget40_leiden_hybrid_siea_ml_gnn_ris_two_tier_tuned_swap_local_search_history.csv; Delegated to existing gnn_ris hybrid path with shared final Monte Carlo evaluation.
