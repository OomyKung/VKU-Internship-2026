"""Unsupervised GraphSAGE embeddings via a graph autoencoder objective."""
...
class GraphSAGEEmbedding(GraphEmbeddingModel):
    """Learn node embeddings with a GraphSAGE encoder and reconstruction loss."""
    ...
    def _fit_impl(
        ...
        *,
        ...
        torch, nn_module, _, gae_cls, _, _, _, sage_conv_cls = require_pyg_dependencies()
