...
STACK_PIPELINE_CONFIGS: dict[str, StackPipelineConfig] = {
    ...
    "graphsage_leiden_ris_ic_ea_memetic": StackPipelineConfig(
        stack_name="graphsage_leiden_ris_ic_ea_memetic",
        community_method="leiden",
    ...
    "graphsage_community_ea_memetic": StackPipelineConfig(
        stack_name="graphsage_community_ea_memetic",
        community_method="leiden",
        embedding_method="graphsage",
    ...
    "graphsage_community_memetic": StackPipelineConfig(
        stack_name="graphsage_community_memetic",
        community_method="leiden",
        embedding_method="graphsage",
        ranking_model="graphsage",
        spread_estimator_search="fairness_aware_ris",
    ...
    "gcn_community_ea_memetic": StackPipelineConfig(
        stack_name="gcn_community_ea_memetic",
        community_method="leiden",
    ...
    "gcn_community_memetic": StackPipelineConfig(
        stack_name="gcn_community_memetic",
        community_method="leiden",
        embedding_method="gcn",
        ranking_model="gcn",
        spread_estimator_search="fairness_aware_ris",
    ...
    "node2vec_xgboost_community_ea_memetic": StackPipelineConfig(
        stack_name="node2vec_xgboost_community_ea_memetic",
        community_method="leiden",
    ...
    "node2vec_xgboost_community_memetic": StackPipelineConfig(
        stack_name="node2vec_xgboost_community_memetic",
        community_method="leiden",
        embedding_method="node2vec",
        ranking_model="xgboost",
        spread_estimator_search="fairness_aware_ris",
